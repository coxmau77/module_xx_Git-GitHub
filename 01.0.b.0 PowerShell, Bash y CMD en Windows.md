# 📌 PowerShell, Bash y CMD en Windows
...
Usando los comandos aprendidos, y asegurandote que estas en el directorio adecuado deberás crear una estructura de directorios y un documento con tu presentación personal.

### ✨ **Nivel 1**

1. **Abre la terminal** (CMD, PowerShell o Bash).
2. **Crea un directorio con tu nombre y apellido.**
...
1. **Dentro de tu directorio, crea dos subdirectorios llamados `img` y `css`.**
...
✅ **Objetivo alcanzado:** Se agregaron directorios y contenido al documento.
...
✅ **Objetivo alcanzado:** Proyecto completo con directorios y documento estructurado.
    ...
    Si quieres probar más comandos, intenta eliminar el documento o alguno de los directorios que creaste.
...
✅ Acceder y utilizar la terminal en Windows, Linux y macOS.
